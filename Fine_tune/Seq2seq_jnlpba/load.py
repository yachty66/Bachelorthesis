...
# restore the saved model weights from Weights & Biases
#wandb.restore("maxhager28/Projects/Bachelor_Thesis/Runs/Seq2seq_jnlpba_strong_18500/Files/lightning_logs/version_0/checkpoints/epoch=0-step=142.ckpt")

# load the restored weights into the model
model.load_state_dict(torch.load("epoch=0-step=142.ckpt"))
